...
export default function SubstackSignup() {
  return (
    <div className="w-full flex justify-center mt-18 md:mt-32 px-4 mb-12 normal-c">
      <div className="w-full max-w-2xl rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-[#0f0f0f] p-6 md:p-8 hover:scale-105 hover:shadow-xl transition">
        ...
        <iframe
          ...
          frameBorder="0"
          scrolling="no"
          className="rounded-xl bg-transparent normal-c"
